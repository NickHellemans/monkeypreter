...
inline struct Object* len(struct ObjectList args, struct MonkeyGC* gc) {
	if(args.size != 1) {
...
inline struct Object* first(struct ObjectList args, struct MonkeyGC* gc) {
	if (args.size != 1) {
		return newEvalError(gc, "wrong number of arguments. got=%d, want=1", args.size);
	}
...
inline struct Object* last(struct ObjectList args, struct MonkeyGC* gc) {
...
inline struct Object* cdr(struct ObjectList args, struct MonkeyGC* gc) {
	const size_t argSize = args.size;
	if (argSize != 1) {
		return newEvalError(gc, "wrong number of arguments. got=%d, want=1", argSize);
	}
...
inline struct Object* push(struct ObjectList args, struct MonkeyGC* gc) {
	const size_t argSize = args.size;
	if (argSize != 2) {
...
inline struct Object* print(struct ObjectList args, struct MonkeyGC* gc) {
